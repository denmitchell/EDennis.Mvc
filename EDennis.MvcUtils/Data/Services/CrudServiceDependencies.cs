...
namespace EDennis.MvcUtils
{
        ...
        where TEntity : class
    {
        ...
        public MvcAuthenticationStateProvider AuthenticationStateProvider { get; set; }
        ...
        public CrudServiceDependencies(DbContextService<TContext> dbContextService,
            MvcAuthenticationStateProvider authStateProvider,
        ...
        class TestAuthenticationStateProvider : MvcAuthenticationStateProvider
        {
