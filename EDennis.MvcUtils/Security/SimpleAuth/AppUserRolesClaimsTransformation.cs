...
namespace EDennis.MvcUtils.Security.SimpleAuth
{
    public class AppUserRolesClaimsTransformation<TAppUserRolesDbContext> : IClaimsTransformation
        where TAppUserRolesDbContext : AppUserRolesContextBase
    {
        ...
        public AppUserRolesClaimsTransformation(IOptionsMonitor<SecurityOptions> securityOptions,
